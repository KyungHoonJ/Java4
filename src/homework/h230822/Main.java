...
public class Main {
	public static void main(String[] args) {
		Characters shadower = new Characters(
			...
			1.2d,
			55);
		System.out.println(shadower.gender);
		...
		Persona pixie = new Persona(
			"픽시",
			"잉글랜드에 전해지는 자그마한 숲의 요정. 사람의 눈을 피해 살지만 우호적이고, 은혜를 베풀면 보답한다고 한다. 게으른 자에게는 벌을 내리는 등 도덕적인 면도 있다. 원래는 세례를 받지 않고 죽은 아이의 영혼이라고도 한다.",
			2,
			1,
			3,
			3,
