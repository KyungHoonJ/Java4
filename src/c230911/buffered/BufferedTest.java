...
public class BufferedTest {
	public static void test() {
		...
		try {
			...
			System.out.println(path + "16654_18066_932.jpg");
			FileInputStream fis = new FileInputStream(path + "16654_18066_932.jpg");
			FileOutputStream fos = new FileOutputStream(path + "output1.jpg");
			
			FileInputStream fis2 = new FileInputStream(path + "16654_18066_932.jpg");
